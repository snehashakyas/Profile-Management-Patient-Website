        ...
        <section className='form'>
            <form onSubmit={onSubmit} enctype="multipart/form-data">
                <div className="form-group">
                    ...
                    {/* <label htmlFor="isStarred">Mark Patient as Special Attention?</label>
                    <Input required type="boolean" id="isStarred" name="isStarred" value={isStarred} variant="filled" mb={3} onChange={onChange}/> */}
                    <label htmlFor="isStarred">Special attention needed?</label>
                    <Input mr={0} checked={isStarred} type="checkbox" id="isStarred" name="isStarred" value={isStarred} variant="filled" mb={3} onChange={onChange}/>
